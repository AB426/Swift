//
//  SearchInstaView.swift
//  tabb
//
//  Created by LeeDongMin on 3/22/16.
//  Copyright © 2016 LeeDongMin. All rights reserved.
//

import UIKit

public class SearchInstaView: UIView {
    
    private var menuTable: BTInstaTableView!
    ...
    public init(aView: UIView!, title: String) {
        ...
        // Init table view
        self.menuTable = BTInstaTableView(frame: CGRectMake((screen.size.width * 11) / 414, menuWrapperBounds.origin.y, (menuWrapperBounds.width * 392) / 414, menuWrapperBounds.height), titleItems: titleItems, arrayForBool: arrayForBool, subTitles: subTitles)
...
// MARK: Table View
class BTInstaTableView: UITableView, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = BTInstaTableViewCell(style: UITableViewCellStyle.Default, reuseIdentifier: "Cell")
    ...
    func tableView(tableView: UITableView, didDeselectRowAtIndexPath indexPath: NSIndexPath) {
        //let cell = tableView.cellForRowAtIndexPath(indexPath) as? BTInstaTableViewCell
    }
}

// MARK: Table view cell
class BTInstaTableViewCell: UITableViewCell {
...
class BTInstaTableCellContentView: UIView {
